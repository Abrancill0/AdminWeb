...
{
    public class RechazarSolicitudCambioCentroController : ApiController
    {
        //Parametros Entrada
        public class ParametrosEntrada
        {
            ...
            public string FiCscMotivoRechazo { get; set; }
        }
        ...
        public DocumentoSalida Post(ParametrosEntrada Datos)
        {
            ...
            entrada.agregaElemento("FiCscMotivoRechazo", Datos.FiCscMotivoRechazo);
