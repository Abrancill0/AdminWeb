...
{
    public class RequisicionDetalleController : ApiController
    {
        public class datos
        {
        ...
        public string Post(datos Datos)
        {
           ...
           // double Iva = Convert.ToDouble(Datos.RmRdePrecioUnitario) * 0.16;
            entrada.agregaElemento("RmRdePorcIva", Convert.ToString(Datos.RmRdePorcIva));
            ...
            {
                var errores = respuesta.Errores.InnerXml;
