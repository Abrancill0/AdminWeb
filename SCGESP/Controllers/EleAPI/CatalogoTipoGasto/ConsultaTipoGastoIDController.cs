...
{
    public class ConsultaTipoGastoIDController : ApiController
    {
        public class Datos
        {
            public string Usuario { get; set; }
            public string Origen { get; set; }
            public string FiTgaId { get; set; }
        }

        public class TipoGastoIDResult
        {
        ...
        public XmlDocument Post(Datos Datos)
        {
            ...
            entrada.agregaElemento("FiTgaId", Datos.FiTgaId);
