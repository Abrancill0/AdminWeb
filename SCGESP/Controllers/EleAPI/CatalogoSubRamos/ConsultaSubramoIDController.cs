...
{
    public class ConsultaSubramoIDController : ApiController
    {
        public class Datos
        {
            public string Usuario { get; set; }
            public string Origen { get; set; }
            public string FiSraId { get; set; }
        }

        public class SubramoIDResult
        {
...
,
            ...
            entrada.agregaElemento("FiSraId", Datos.FiSraId);
