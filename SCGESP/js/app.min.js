...
$(window).on("load", function () {
    ...
    $("body").on("change", ".theme-switch input:radio", function () {
        ...
        localStorage.setItem("colortb", a);
        ...
        console.log(a);
        a.preventDefault(),
            $(this).parent().toggleClass("navigation__sub--toggled"), $(this).next("ul").slideToggle(250)
    ...
    if ($("#dropzone-upload")[0] && $("#dropzone-upload").dropzone({ url: "/file/post", addRemoveLinks: !0 }), $(".datetime-picker")[0] && $(".datetime-picker").flatpickr({ enableTime: !0, nextArrow: '<i class="zmdi zmdi-long-arrow-right" />', prevArrow: '<i class="zmdi zmdi-long-arrow-left" />' }), $(".date-picker")[0] && $(".date-picker").flatpickr({ enableTime: !1, nextArrow: '<i class="zmdi zmdi-long-arrow-right" />', prevArrow: '<i class="zmdi zmdi-long-arrow-left" />' }), $(".time-picker")[0] && $(".time-picker").flatpickr({ noCalendar: !0, enableTime: !0 }), $("#input-slider")[0]) {
        ...
        noUiSlider.create(b, { start: [20], connect: "lower", range: { min: 0, max: 100 } }), b.noUiSlider.on("update", function (a, b) {
            document.getElementById("input-slider-value").value = a[b]
        })
    }
    if ($("#input-slider-range")[0]) {
        var c = document.getElementById("input-slider-range"), d = document.getElementById("input-slider-range-value-1"), e = document.getElementById("input-slider-range-value-2"), f = [d, e];
        noUiSlider.create(c, { start: [20, 80], connect: !0, range: { min: 0, max: 100 } }), c.noUiSlider.on("update", function (a, b) {
            f[b].value = a[b]
        })
    }
    if ($(".input-slider")[0])
    ...
    if ($(".color-picker")[0] && ($(this).each(function () {
        ...
        $('[data-toggle="tooltip"]')[0] && $('[data-toggle="tooltip"]').tooltip(), $(".widget-calendar__body")[0]) {
    ...
    $("body").on("click", "[data-ma-action]", function (b) {
        ...
        switch (d) {
            ...
            /*case 'profile-menu-toggle':
                ...
                //localStorage.setItem("elemnto perfil", ncountp);
                //ncountp++;
                break;*/
            ...
            case "fullscreen":
                ...
                break;
            case "visble-menu":
                var visible = $('[data-ma-action="visble-menu"]').attr("visible") * 1;
                Seguridad.visiblemenu(visible);
                break;
            case "print":
                window.print();
                break;
            ...
            case "rbrowseayuda":
                b.stopPropagation();
                $("#search_ayuda").focus();
                $("#search_ayuda").val(b.currentTarget.dataset['valueSearch']);
...
function abreMenuPerfil(elemento) {
    $(elemento).parent().toggleClass('toggled');
    $(elemento).next().slideToggle(200);
}

function abreMenuModulo(elemento) {
    //a.preventDefault(),
        $(elemento).parent().toggleClass("navigation__sub--toggled"), $(elemento).next("ul").slideToggle(250);
}